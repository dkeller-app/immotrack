...
import { splitBlockAcrossPages } from './pdf-flow.js';
import { brandzoneModel, propryoMarkOps } from './doc-brand.js';
import { pdfSafeText } from './montant-doc.js';
 ...
 * porté par {ref, date}.
 */
export function parseDocDoc(html) {
...
export function docWords(parsed) {
  const p = parsed || {};
 ...
 */
export function renderDocToPdf(pdf, ent, parsed, PN) {
  PN = PN || PDF_NATIVE;
 ...
 * @returns {Blob}
 */
export function docHtmlToPdfBlob(JsPdfCls, ent, html, opts) {
  opts = opts || {};
