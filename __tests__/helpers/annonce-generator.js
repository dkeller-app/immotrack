...
// ═══════════════════════════════════════════════════════════════
let _seed = 1;
export function setSeed(s) { _seed = (s | 0) || 1; }
...
export function seedFromString(s, counter = 0) {
  let hash = 0;
...
// ═══════════════════════════════════════════════════════════════
export const MAP_EXPO = Object.freeze({
...
export const MAP_VUE = Object.freeze({
...
export const MAP_CAR = Object.freeze({
...
export const TONS_VALIDES = Object.freeze(['factuel', 'storytelling', 'convivial', 'haut-gamme']);
export const FORMATS_VALIDES = Object.freeze(['leboncoin', 'detaille', 'sms']);
...
export function garantiesLabel(g) {
...
// ═══════════════════════════════════════════════════════════════
export const BANQUE_TITRES = Object.freeze({
  storytelling: [
...
export function genererTitre(log, imm, ton = 'storytelling') {
...
export function genererAccroche(log, imm, ton = 'storytelling') {
...
export function genererDescription(log, ton = 'storytelling') {
...
export function genererAtouts(log, imm) {
  const atouts = [];
...
export function genererQuartier(log, imm, ton = 'storytelling') {
...
export function genererDossier(_log) {
  return {
    pieces: [
...
// ═══════════════════════════════════════════════════════════════
export function genererAnnonce(log, imm, bail, opts = {}) {
  if (!log) log = {};
  if (!imm) imm = {};
  if (!bail) bail = {};
