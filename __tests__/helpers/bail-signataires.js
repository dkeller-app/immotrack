...
/** Convention d'id historique du signataire mandataire (pas d'index : il est seul). */
export const ID_MANDATAIRE = 'bailleur';
 ...
 */
export function resolveBailleurSigners(input) {
  const o = input || {};
...
export function bailleurSignerIds(input) {
 ...
 */
export function padSignersFor(sigs, opts) {
  var o = opts || {};
