...
export function mrhManquante(scopeLogs, mrhList) {
...
export function mrhEcheances(mrhList, logements, activeEnt, today, horizon = 30) {
  const out = []
...
export function pnoEcheances(assurances, logements, activeEnt, today, horizon = 30) {
  const out = []
...
export function irlClassifier(rev, log, today, isoLocal) {
...
export function bauxEcheance(scopeLogs, today, horizon = 90) {
  const out = []
