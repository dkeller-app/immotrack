...
| **Aides à la création — RECHERCHE FAITE 24/08** ([AIDES-CREATION.md](AIDES-CREATION.md)) | **Maintien ARE = pilier** (~0,35 € perdu par € de CA ; ⚠️ plafond 60 % possible selon date de fin de contrat) · **ARCE écartée** · ACRE nouvelle formule 15,9 % (décret 02/2026, demande ≤ 60 j) · CFE 0 € 2026 (1447-C avant 31/12) · prêt d'honneur Initiative Sud Alsace 5-30 K€ taux 0 · Bourse French Tech ≤ 30 K€ si incubateur | **ACTION N°1 DIDIER : écrire à France Travail** (reliquat ARE + plafond 60 % oui/non) + Activ'Créa · **arbitrage immatriculation au 1er OCTOBRE** (12 mois pleins d'ACRE, reco à confirmer comptable) |
