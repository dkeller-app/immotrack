...
| **Aides à la création — RECHERCHE FAITE 24/08** ([AIDES-CREATION.md](AIDES-CREATION.md)) | **Maintien ARE = pilier** (~0,35 € perdu par € de CA ; ⚠️ plafond 60 % possible selon date de fin de contrat) · **ARCE écartée** · ACRE nouvelle formule 15,9 % (décret 02/2026, demande ≤ 60 j) · CFE 0 € 2026 (1447-C avant 31/12) · prêt d'honneur Initiative Strasbourg 3-15 K€ taux 0 · Bourse French Tech ≤ 30 K€ si incubateur | **CHIFFRÉ 24/08 sur données réelles** : AJ 188,20 € × 315 j = 59 283 € · plafond 60 % APPLICABLE (fin de contrat 30/11/2025) → **~5 600 €/mois jusqu'à ~avril 2027** (35,6 K€) + réserve 23,7 K€ via saisine IPR (à planifier mars 2027) · confirmation écrite FT à obtenir · Activ'Créa · **immatriculation au 1er OCTOBRE** (12 mois pleins d'ACRE, à confirmer comptable) · dossier prêt d'honneur Initiative Strasbourg à déposer à l'automne (réserve de pont) |
