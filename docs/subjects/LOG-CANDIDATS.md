...
- 2026-06-02 : **4 questions ouvertes tranchées par user** → purge RGPD des refusés à **30 j** (D11) ; onglet Candidats **entre Locataires et Mouvements** (D9) ; **demande de complément** supportée (réouverture lien + re-notif, D13) ; lien générable depuis **3 points d'entrée** (annonce / onglet Candidats / fiche bien vacant) — ne dépend pas d'une annonce ImmoTrack (D12). Spec mise à jour. En attente validation finale du spec avant plan d'implémentation.
