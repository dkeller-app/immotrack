...
- 2026-07-05 : layout validé dans le mockup B : parc pleine hauteur gauche (tableau condensé, 12 lots sans scroll à 900px), colonne Quit. point/– conservée. Implémentation à suivre avec DASH-ACTIONS-REFONTE.

- 2026-07-06 : ✅ **LIVRÉ v15.418** origin/main (c04f88c). Parc COMPLET pleine hauteur (fini slice(0,8)), tri + intercalaires immeuble (nb lots + HC), scroll interne, page calée viewport (mockup B + retours user : bulle figée, widgets épinglés). Colonne Quittance : vert émise / rouge demandée non émise (nouveau flag bail.quittanceDemandee, case art. 21 dans la modale bail) / – non demandée. États bail alignés v15.343 : Reconduit (tacite) vs Échu rouge (mobilité/étudiant/garage) — même verdict que l onglet Baux.
