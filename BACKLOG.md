...
|---|---|---|---|---|---|
| APL-TIERS-PAYANT | **Prise en compte CAF/APL en tiers payant** (le versement CAF au bailleur compte comme loyer) — champ APL sur bail + reconnaissance import + split dans le Suivi ; corrige les faux « partiels » | P1 | M | ⬜ À faire | [docs/subjects/APL-TIERS-PAYANT.md](docs/subjects/APL-TIERS-PAYANT.md) |
