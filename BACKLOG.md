...
> |---|---|---|---|
> | P0.1 Sauver créations Marion (localStorage PC → réimport espace `2e5c49db`) | P0 | S | 🔄 **KIT PRÊT 13/07** : guide `_import/P0.1-MARION-RECUP.md` (snippet console d'export à lui faire exécuter SANS se connecter — v15.463 purge le miroir au login) + script tri/réimport `_import/p01-marion-import.mjs` (dry-run par défaut, diff miroir−cloud Didier, garde en dur espace Marion). ⚠️ Marion consignée hors app d'ici là |
...
> | 4 | Fil rouge création bailleur → immeuble → logement + import acte de vente | [FLOW-CREATION-BIEN](docs/subjects/FLOW-CREATION-BIEN.md) 🚀 **DÉPLOYÉ v15.464** (coquille `#ov-parcours-bien` · acte phase 1 · multi-ajout + suppression tombstone · 100% réutilisation modales · garde Identité · 2 passes audit PASS · 1917/1917). Spec `2026-07-09-fil-rouge-creation-bien-design.md`. Reste : smoke test user (⚠ cache PWA) | P1 | L | 🏠 Chantier Biens |
