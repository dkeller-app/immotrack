...
| ARCHI-MODULAR | Refonte modulaire monolithe index.html (ES modules natifs ou Vite) | P1 | XL | 🟡 **Reporté post-V1** (décision Sprint 2 marathon 2026-05-11) | [docs/strategie/ARCHI-MODULAR-FAISABILITE.md](docs/strategie/ARCHI-MODULAR-FAISABILITE.md) · **Stratégie 2 retenue** (ES modules natifs sans bundler, ~13 j-h). Recommandation rapport : ne PAS modulariser avant V1 commerciale (Q4 2026), focaliser bloquants V1. Cible : Q1 2027 post-V1. Fonctions monstres à splitter (previewBailData 1916l, buildDashWidget 892l, buildBailStructure 720l, _renderImmFichePlanGantt 432l, initDB 265l) traitées en sous-phase. **Sprint 2 marathon = SKIP intentionnel** pour réinvestir 12 j-h dans conformité légale Sprint 3. |
