...
> |---|---|---|---|
> | P0.1 Sauver créations Marion | P0 | S | ✅ **CLOS 14/07** — export miroir fait avec Marion (`_import/marion-miroir-2026-07-14.json`, 70 Ko, conservé), dry-run : ses « créations » = RE-COPIES du vrai portefeuille Ferrette (immeuble + 6 logements sans tiret) → **décision : PAS de réimport** (univers parallèle de la même SCI ; à terme = ré-invitation sur la vraie SCI). 🎯 **Récupéré : le bail Baysang/Ferrette-001 perdu par B-REBAIL** (Tiffany Baysang, 0759168629, baysang.tiff@gmail.com, 495+30 €, DG 495, 18/07/2026→17/07/2032, non signé). Marion reconnectée = espace propre + défauts |
