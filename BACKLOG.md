...
| 💾 **Drive sync** | **BUG-DRIVE-SAVELOOP ✅ Fixé v15.118 (P0, boucle save infinie → auto-pull jamais exécuté → sync inter-onglets/appareils cassée + FAB figé ; bug latent depuis v14.0)** · **DRIVE-CONFIANCE-UX 🔄 (P1, B ✅ v15.114 messages + A0 ✅ v15.116 offline-first + timeout fetch v15.117 ; reste A1/A4/A5 boot modal+Opera + C panneau état)** · DRIVE-ARBORESCENCE 🔄 (P1) · DRIVE-2H (P1) · DRIVE-2F (P1) · DRIVE-2G (P1) · DRIVE-2K ⚠️ englobé (P2) · DRIVE-2I (P2) · DRIVE-2J (P3) |
