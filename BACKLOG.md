...
| **Signature à distance — FINITION** (lancé 11/08, **Opus** — quota Fable user) | §1-5 du fix DÉJÀ en prod depuis v15.484 (re-vérifié v15.501) ; session = `PROMPT-CHANTIER-SIGNATURE-FINITION.md` | lot B page publique locataire design Propryo (mockup-first) · lot C route reclaim worker (§7 doublon PDF : déjà en prod, vérifié) · DoD = smoke E2E compte frais (jamais fait) |
