...
|  | FOUNDER-EDITION | Pricing lifetime 249 € × 100 places acquisition early adopters pré-launch | P1 | S | ⬜ À faire (décision urgente) | [docs/subjects/FOUNDER-EDITION.md](docs/subjects/FOUNDER-EDITION.md) · réaction LocataireCloud (347 € × 50 places) · option (b) recommandée : 24 900 € cash up-front + 100 évangélistes · annonce juillet 2026 · setup 1,5 j-h Stripe + tag DB |
