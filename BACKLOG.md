...
| 💾 **Drive sync** | **DRIVE-LOOP-MARATHON ✅ Résolu v15.114→126 (P0, 9 bugs : messages anxiogènes B v114 · offline-first anti-perte A0 v116 · timeout fetch v117 · boucle save finally v118 · boucle pull totalConflicts v120-121 · re-stamp signature v122 · ping-pong inter-onglets v123 · boucle pull→saveDB→push v124 · spam toast pull v125 · cleanup v126)** · *reste : migration ARCHI re-enrichit 23 logements/boot → push 9s à chaque ouverture (optimisable) · A1/A4/A5 boot modal+Opera · C panneau état* · DRIVE-ARBORESCENCE 🔄 (P1) · DRIVE-2H (P1) · DRIVE-2F (P1) · DRIVE-2G (P1) · DRIVE-2K ⚠️ englobé (P2) · DRIVE-2I (P2) · DRIVE-2J (P3) |
...
| 📱 **Mobile / PWA / Offline** | BUG-MOBILE-MENU-PLUS (P0) · BUG-MOBILE-DASH-PROFILES (P0) · MOBILE-AUDIT-ONGLETS Phase 5 polish 🔄 (P1) · MOBILE-PWA-OFFLINE (P2) |
...
|  | BUG-MOBILE-MENU-PLUS | **P0 bug fonctionnel mobile** : menu "Plus" bottom nav ne s'ouvre pas → 12 fonctions sur 16 inaccessibles mobile | P0 | S | ⬜ À faire | [docs/subjects/BUG-MOBILE-MENU-PLUS.md](docs/subjects/BUG-MOBILE-MENU-PLUS.md) · détecté audit mobile v15.73 par utilisateur 2026-05-18 · drawer slide-up grid 2-col + 12 entrées + backdrop · 1-2 h fix |
|  | BUG-MOBILE-DASH-PROFILES | **P0 bug fonctionnel mobile** : sélecteur profil dashboard (Solo/Premium/Gestionnaire) inaccessible mobile | P0 | XS | ⬜ À faire | [docs/subjects/BUG-MOBILE-DASH-PROFILES.md](docs/subjects/BUG-MOBILE-DASH-PROFILES.md) · détecté audit mobile v15.73 par utilisateur 2026-05-18 · pills compactes S/P/G header OU drawer Plus · 30 min - 1 h fix |
